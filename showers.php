...
echo template_header('Kenadd showers');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/bathroom/showers/sidebar.php' ?>
                  <?php include 'categories/bathroom/showers/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/bathroom/showers/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
