...
echo template_header('Kenadd hotels');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/accommodation/hotels/sidebar.php' ?>
                  <?php include 'categories/accommodation/hotels/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/accommodation/hotels/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
