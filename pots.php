...
echo template_header('Kenadd pots');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/storage-and-organizers/pots/sidebar.php' ?>
                  <?php include 'categories/storage-and-organizers/pots/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/storage-and-organizers/pots/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
