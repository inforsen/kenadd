...
echo template_header('Kenadd Beds');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/beds/sidebar.php' ?>
                  <?php include 'categories/furniture/beds/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/beds/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
