...
echo template_header('Kenadd paper holders');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/toilet/paper-holders/sidebar.php' ?>
                  <?php include 'categories/toilet/paper-holders/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/toilet/paper-holders/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
