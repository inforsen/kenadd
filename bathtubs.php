...
echo template_header('Kenadd bathtubs');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/toilet/bathtubs/sidebar.php' ?>
                  <?php include 'categories/toilet/bathtubs/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/toilet/bathtubs/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
