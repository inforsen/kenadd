...
echo template_header('Kenadd Chandeliers');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/chandeliers/sidebar.php' ?>
                  <?php include 'categories/lighting/chandeliers/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/chandeliers/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
