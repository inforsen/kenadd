...
echo template_header('Kenadd bungalow');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/accommodation/bungalow/sidebar.php' ?>
                  <?php include 'categories/accommodation/bungalow/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/accommodation/bungalow/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
