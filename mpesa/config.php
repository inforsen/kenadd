...
function insert_response($jsonMpesaResponse){
	...
	**/
	...
	# 1.1. Config Section
		...
		$dbHost = 'localhost';
		$dbUser = 'cartsenc_festus';
		$dbPass = 'AbbY@Nz!26@FeZzaH';*/
	...
	try{
		$insert = $con->prepare("INSERT INTO `mpesapaystab`(`CommandID`, `TransID`, `TransTime`, `TransAmount`, `ShortCode`, `BillRefNumber`, `InvoiceNumber`, `OrgAccountBalance`, `ThirdPartyTransID`, `MSISDN`, `FirstName`, `MiddleName`, `LastName`) VALUES (:CommandID, :TransID, :TransTime, :TransAmount, :ShortCode, :BillRefNumber, :InvoiceNumber, :OrgAccountBalance, :ThirdPartyTransID, :MSISDN, :FirstName, :MiddleName, :LastName)");
  ...
  //header('Location: index.php?page=place-order'); 
}
