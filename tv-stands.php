...
echo template_header('Kenadd TV Stands');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/tv-stands/sidebar.php' ?>
                  <?php include 'categories/furniture/tv-stands/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/tv-stands/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
