...
echo template_header('Kenadd Wall Units');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/wall-units/sidebar.php' ?>
                  <?php include 'categories/furniture/wall-units/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/wall-units/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
