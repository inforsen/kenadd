...
echo template_header('Kenadd soap-dishes');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/bathroom/soap-dishes/sidebar.php' ?>
                  <?php include 'categories/bathroom/soap-dishes/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/bathroom/soap-dishes/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
