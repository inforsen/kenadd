...
echo template_header('Kenadd wall mounts and cabinets');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/toilet/wall-mounts-and-cabinets/sidebar.php' ?>
                  <?php include 'categories/toilet/wall-mounts-and-cabinets/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/toilet/wall-mounts-and-cabinets/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
