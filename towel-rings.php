...
echo template_header('Kenadd towel rings');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/bathroom/towel-rings/sidebar.php' ?>
                  <?php include 'categories/bathroom/towel-rings/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/bathroom/towel-rings/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
