...
echo template_header('Kenadd Luminaire');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/luminaire/sidebar.php' ?>
                  <?php include 'categories/lighting/luminaire/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/luminaire/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
