...
echo template_header('Kenadd Wooden Planters');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/plants-and-planters/wooden-planters/sidebar.php' ?>
                  <?php include 'categories/plants-and-planters/wooden-planters/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/plants-and-planters/wooden-planters/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
