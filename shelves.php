...
echo template_header('Kenadd shelves');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/bathroom/shelves/sidebar.php' ?>
                  <?php include 'categories/bathroom/shelves/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/bathroom/shelves/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
