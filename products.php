...
echo template_header('Kenadd All Products');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/products/sidebar.php' ?>
                  <?php include 'categories/products/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/products/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
