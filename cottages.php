...
echo template_header('Kenadd cottages');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/accommodation/cottages/sidebar.php' ?>
                  <?php include 'categories/accommodation/cottages/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/accommodation/cottages/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
