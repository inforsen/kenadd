...
echo template_header('Kenadd Engraving');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/arts-and-prints/engraving/sidebar.php' ?>
                  <?php include 'categories/arts-and-prints/engraving/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/arts-and-prints/engraving/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
