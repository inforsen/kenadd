...
echo template_header('Kenadd Photography');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/arts-and-prints/photography/sidebar.php' ?>
                  <?php include 'categories/arts-and-prints/photography/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/arts-and-prints/photography/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
