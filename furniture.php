...
echo template_header('Kenadd furniture');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/office-furniture/furniture/sidebar.php' ?>
                  <?php include 'categories/office-furniture/furniture/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/office-furniture/furniture/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
