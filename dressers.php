...
echo template_header('Kenadd dressers');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/dressers/sidebar.php' ?>
                  <?php include 'categories/furniture/dressers/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/dressers/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
