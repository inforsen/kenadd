...
echo template_header('Kenadd fittings');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/toilet/fittings/sidebar.php' ?>
                  <?php include 'categories/toilet/fittings/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/toilet/fittings/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
