...
echo template_header('Kenadd cookware');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/kitchen/cookware/sidebar.php' ?>
                  <?php include 'categories/kitchen/cookware/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/kitchen/cookware/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
