...
echo template_header('Kenadd Chairs');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/chairs/sidebar.php' ?>
                  <?php include 'categories/furniture/chairs/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/chairs/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
