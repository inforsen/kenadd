...
echo template_header('Kenadd chalet');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/accommodation/chalet/sidebar.php' ?>
                  <?php include 'categories/accommodation/chalet/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/accommodation/chalet/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
