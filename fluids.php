...
echo template_header('Kenadd Fluids');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/storage-and-organizers/fluids/sidebar.php' ?>
                  <?php include 'categories/storage-and-organizers/fluids/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/storage-and-organizers/fluids/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
