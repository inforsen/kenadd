...
echo template_header('Kenadd Wool');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/textiles-and-rags/wool/sidebar.php' ?>
                  <?php include 'categories/textiles-and-rags/wool/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/textiles-and-rags/wool/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
