...
echo template_header('Kenadd Led Stripes');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/led-stripes/sidebar.php' ?>
                  <?php include 'categories/lighting/led-stripes/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/led-stripes/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
