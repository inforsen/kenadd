...
echo template_header('Kenadd Linocut');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/arts-and-prints/linocut/sidebar.php' ?>
                  <?php include 'categories/arts-and-prints/linocut/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/arts-and-prints/linocut/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
