...
echo template_header('Kenadd cutlery');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/kitchen/cutlery/sidebar.php' ?>
                  <?php include 'categories/kitchen/cutlery/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/kitchen/cutlery/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
