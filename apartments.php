...
echo template_header('Kenadd apartments');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/accommodation/apartments/sidebar.php' ?>
                  <?php include 'categories/accommodation/apartments/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/accommodation/apartments/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
