...
echo template_header('Kenadd Lighting');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/office-furniture/lighting/sidebar.php' ?>
                  <?php include 'categories/office-furniture/lighting/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/office-furniture/lighting/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
