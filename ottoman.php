...
echo template_header('Kenadd Ottoman');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/ottoman/sidebar.php' ?>
                  <?php include 'categories/furniture/ottoman/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/ottoman/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
