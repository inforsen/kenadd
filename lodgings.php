...
echo template_header('Kenadd lodgings');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/accommodation/lodgings/sidebar.php' ?>
                  <?php include 'categories/accommodation/lodgings/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/accommodation/lodgings/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
