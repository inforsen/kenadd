...
echo template_header('Kenadd pet clothing');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/pet-supplies/pet-clothing/sidebar.php' ?>
                  <?php include 'categories/pet-supplies/pet-clothing/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/pet-supplies/pet-clothing/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
