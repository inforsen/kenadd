...
echo template_header('Kenadd Tables');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/tables/sidebar.php' ?>
                  <?php include 'categories/furniture/tables/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/tables/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
