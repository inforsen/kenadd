...
echo template_header('Kenadd ovens');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/kitchen/ovens/sidebar.php' ?>
                  <?php include 'categories/kitchen/ovens/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/kitchen/ovens/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
