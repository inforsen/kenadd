...
echo template_header('Kenadd Tapestries');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/arts-and-prints/tapestries/sidebar.php' ?>
                  <?php include 'categories/arts-and-prints/tapestries/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/arts-and-prints/tapestries/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
