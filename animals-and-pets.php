...
echo template_header('Kenadd Animals and pets');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/animals-and-pets/sidebar.php' ?>
                  <?php include 'categories/furniture/animals-and-pets/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/animals-and-pets/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
