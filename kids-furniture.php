...
echo template_header('Kenadd Kids furniture');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/kids-furniture/sidebar.php' ?>
                  <?php include 'categories/furniture/kids-furniture/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/kids-furniture/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
