...
echo template_header('Kenadd Scones');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/scones/sidebar.php' ?>
                  <?php include 'categories/lighting/scones/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/scones/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
