...
echo template_header('Kenadd toothbrush-holders');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/bathroom/toothbrush-holders/sidebar.php' ?>
                  <?php include 'categories/bathroom/toothbrush-holders/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/bathroom/toothbrush-holders/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
