...
echo template_header('Kenadd faucets');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/kitchen/faucets/sidebar.php' ?>
                  <?php include 'categories/kitchen/faucets/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/kitchen/faucets/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
