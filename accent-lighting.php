...
echo template_header('Kenadd Accent Lighting');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/accent-lighting/sidebar.php' ?>
                  <?php include 'categories/lighting/accent-lighting/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/accent-lighting/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
