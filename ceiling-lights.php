...
echo template_header('Kenadd Ceiling Lights');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/ceiling-lights/sidebar.php' ?>
                  <?php include 'categories/lighting/ceiling-lights/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/ceiling-lights/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
