...
echo template_header('Kenadd Fill Lights');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/fill-lights/sidebar.php' ?>
                  <?php include 'categories/lighting/fill-lights/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/fill-lights/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
