    ...
    <div class="container">
        <div class="dashAlign">
            ...
            <div class="dashAlignContainer dashFit lineDashtwo">
                <?php
                    $get_pending_orders = $getFromU->viewCustomerOrders("customer_orders");
        ...
        <div class="dashAlignTwo">
            <div class="dashAlignContainer lineDashfour">                           
                <?php
                    $get_customers = $getFromU->countCustomers("vendorproduct");
                    $count_customers = count($get_customers);
                ?>
                <div class="appData">
          ...
          <div class="visit_statistics">
            ...
            <div class="table_scroll">
              <table>
                ...
                <?php
                    $customer_orders = $getFromU->viewDashboardOrdersFromTable('customer_orders');
