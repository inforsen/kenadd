...
<?php
    ...
    if (isset($_GET['product_id'])) {
        ...
        $title= $view_product->product_title;
        $description= $view_product->product_desc;
        $new_price= $view_product->product_price;
        $old_price= $view_product->rrp;
        $sku= $view_product->sku;
        $productimg1= $view_product->product_img1;
        $productimg2= $view_product->product_img2;
        $productimg3= $view_product->product_img3;

        $productimg4= $view_product->product_img4;
        $productimg5= $view_product->product_img5;
        $productimg6= $view_product->product_img6;

        $cat_id= $view_product->cat_id;
        $brand= $view_product->brand_name;
        $weight= $view_product->weight;
        $store_name= $view_product->store_name;
        $features= $view_product->keyfeatures;
        $homecat_id= $view_product->homecat_id;
    ...
    if (isset($_POST['save_edit'])) {
        ...
        $edit_package = $getFromU->edit_product("products", $product_id, array("title" => $title, "new_price" => $new_price, "old_price" => $old_price, "brand" => $brand, "sku" => $sku, "weight" => $weight, "store_name" => $store_name, "description" => $description, "features" => $features, "cat_id" => $cat_id, "homecat_id" => $homecat_id, "image_one" => $image_one, "image_two" => $image_two, "image_three" => $image_three, "image_four" => $image_four, "image_five" => $image_five, "image_six" => $image_six, "add_date" => date("Y-m-d H:i:s")));
                        ...
                        <div class="itemLabelAlign">
                            ...
                            <div class="itemLabel">
                                <div class="item_input">
                                    ...
                                    <input type="text" name="sku" placeholder="e.g SQL23KENADD"  placeholder="<?php echo $sku; ?>" value="<?php echo $sku; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="itemLabelAlign">
                    ...
                    <div class="catLabelContainer">
                        <div class="collection_styling">
                            ...
                            <div class="collection_description">
                                <?php
                                    $categories = $getFromU->viewHomeProductCategor("homecat", $homecat_id);
                                    foreach ($categories as $category) {
                                        $homecat_name = $category->homecat_name;
                                    ?>
                                  <div class="product_col_name">
                                    <p ><strong>Currently:</strong> <?php echo $homecat_name; ?> </p>
                                  </div>                        
                                <?php } ?>
