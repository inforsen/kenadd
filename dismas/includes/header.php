            ...
            <div class="menuContainer" id="dash_menu">
                ...
                <div class="leftDataContent">
                    <div class="leftData">
                        ...
                        <a href="customers.php"><i class="fa fa-users"></i>Customer Tab</a>
                        <a href="vendors.php"><i class="fa fa-user-circle"></i>Vendors</a>
                    </div>
                    <div class="leftData">
                        <h4>Organize and Manage</h4>
                        <a href="inventory.php"><i class="fa fa-life-ring"></i>Inventory</a>
                        <a href="store-orders.php"><i class="fa fa-sitemap"></i>Store Orders</a>
                        <a href="approvals.php"><i class="fa fa-gavel"></i>Product Approvals</a>
                    </div>
                    <div class="leftData">
                        <h4>Marketing &amp; SEO</h4>
                        <a href="coupon.php"><i class="fa fa-creative-commons"></i>Coupons</a>
                        <a href="reviews.php"><i class="fa fa fa-comments-o"></i>Customer Reviews</a>
                    </div>
                    <div class="leftData">
                        <h4>Extras</h4>
                        <a href="settings.php"><i class="fa fa fa-cogs"></i>Settings</a>
