...
echo template_header('Kenadd Live Plants');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/plants-and-planters/live-plants/sidebar.php' ?>
                  <?php include 'categories/plants-and-planters/live-plants/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/plants-and-planters/live-plants/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
