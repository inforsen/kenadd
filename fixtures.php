...
echo template_header('Kenadd Fixtures');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/office-furniture/fixtures/sidebar.php' ?>
                  <?php include 'categories/office-furniture/fixtures/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/office-furniture/fixtures/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
