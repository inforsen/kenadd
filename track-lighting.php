...
echo template_header('Kenadd Track Lighting');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/track-lighting/sidebar.php' ?>
                  <?php include 'categories/lighting/track-lighting/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/track-lighting/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
