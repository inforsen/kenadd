...
echo template_header('Kenadd homestays');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/accommodation/homestays/sidebar.php' ?>
                  <?php include 'categories/accommodation/homestays/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/accommodation/homestays/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
