...
echo template_header('Kenadd Painting');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/arts-and-prints/painting/sidebar.php' ?>
                  <?php include 'categories/arts-and-prints/painting/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/arts-and-prints/painting/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
