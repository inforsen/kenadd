...
echo template_header('Kenadd fittings and handles');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/kitchen/fittings-and-handles/sidebar.php' ?>
                  <?php include 'categories/kitchen/fittings-and-handles/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/kitchen/fittings-and-handles/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
