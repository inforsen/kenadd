...
if (isset($_POST['add_product'])) {
        ...
        $insert_package = $getFromU->create("vendorproduct", array("title" => $title, "new_price" => $new_price, "old_price" => $old_price, "brand" => $brand, "sku" => $sku, "weight" => $weight, "store_name" => $store_name, "description" => $description, "features" => $features, "cat_id" => $cat_id, "homecat_id" => $homecat_id, "image_one" => $image_one, "image_two" => $image_two, "image_three" => $image_three, "image_four" => $image_four, "image_five" => $image_five, "image_six" => $image_six, "add_date" => date("Y-m-d H:i:s")));
        ...
        <form method="POST" enctype="multipart/form-data">                         
            <div class="container">
                ...
                <div class="add_package">
                    ...
                    <button class="save_button" type="submit" name="add_product">Save</button>
                </div> 
