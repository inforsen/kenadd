        ...
        <div class="container">
            ...
            <div class="notification_main_africa">
              ...
              <div class="visit_statistics">
                <?php
                    $get_orders = $getFromU->countVendorCustomerOrders("customer_orders", $vendor_id);
                ...
                <div class="table_scroll">
                  ...
                  <?php
                      $customer_orders = $getFromU->viewVendorCustomerOrderss($start_from, $per_page, $vendor_id);
                      $countCustmerOrders = count($customer_orders);
                      if ($countCustmerOrders == 0) {
                          ?>
                      ...
                      foreach ($customer_orders as $customer_order) {
                        ...
                        <form method="POST">
                          <tr>
                            <td style="width: 10%; font-size: 14px;">#<?php echo $invoice_no; ?></td>
                            <td style="width: 20%; font-size: 14px;"><?php echo $customer_name; ?></td>
                            <td style="width: 15%; font-size: 14px;" class="ship_div"><?php echo $productname; ?></td>
                            ...
                            <td style="width: 22%;"><a href="print-order.php?invoice_no=<?php echo $invoice_no; ?>">View</a></td>
                          </tr>
                      </form>
                  <?php } } ?>
                  </table>
