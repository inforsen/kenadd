...
<?php
    ...
    if (isset($_POST['new_passcode'])) {
        $vendor_pass = $_POST['new_vendor_pass'];
        $confirm_vendor_pass = $_POST['confirm_vendor_pass'];

        if ($vendor_pass !== $confirm_vendor_pass) {
                $error = "Passwords do not match";
            } else {
                $update_vendor_pass = $getFromU->update_vendor_password($vendor_id, $vendor_pass);
                if ($update_vendor_pass === true) {
                ...
                <div class="login_form_left_cont_ent">
                    ...
                    <form method="POST">
                        ...
                        <div class="login_input login_input_margin">
                            ...
                            <input type="password" name="new_vendor_pass" placeholder="Enter new passcode" required>
                        </div>
                        <div class="login_input">
                            <label>Confirm Passcode</label>
                            <input type="password" name="confirm_vendor_pass" placeholder="Confirm new passcode" required>
                        </div>
