...
<div class="rightContainer">
    ...
    <div class="container">
      <div class="dashHeader">
            <p>Products Waiting Approval by Admin</p>
        ...
        <div class="notification_main_africa">
          ...
          <div class="visit_statistics">
            <?php
                $get_inventory = $getFromU->countVendorProductsNum("vendorproduct", $vendor_id);
            ...
            <div class="table_scroll">
              <table id="expan_table">
                <tr>
                  ...
                  <?php
                      $view_products = $getFromU->viewVendorProductsFromTable('vendorproduct', $start_from, $per_page, $vendor_id);
              ...
              <?php
                  $total_pages = $getFromU->countProducts("approveproduct", $per_page);
                  if ($total_pages >=2) {
              ?>
                  <a class="<?php if(isset($_GET['$page']) == 1) { echo 'active';}?>" href="waiting-approval.php?$page=1">1</a>
              <?php
                      for ($i = 2; $i < $total_pages; $i++) {
              ?>
                  <a class="<?php if(isset($_GET['$page']) == $i) { echo 'active';}?>" href="waiting-approval.php?$page=<?php echo $i; ?>"><?php echo substr($i, 0, 5); ?></a>
              <?php } ?>
                  <a class="<?php if(isset($_GET['$page']) == $total_pages) { echo 'active';}?>" href="waiting-approval.php?$page=<?php echo $total_pages; ?>">Last</a>
              <?php } ?>
              </div>
            </div>
          </div>
