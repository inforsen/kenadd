...
echo template_header('Kenadd pantry');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/storage-and-organizers/pantry/sidebar.php' ?>
                  <?php include 'categories/storage-and-organizers/pantry/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/storage-and-organizers/pantry/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
