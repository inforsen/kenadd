                        ...
                        <div id="search_filters">
                           ...
                           <section class="facet clearfix heightside">
                              ...
                              <ul id="facet_50774" class="collapse">
                                 <?php
                                 $cats = $getFromU->viewluminairesBrand("products");
                                 foreach ($cats as $cat) {
                                    $brandname = $cat->brand_name;
                                    $brand_id = $cat->brand_id;

                                    $get_brands = $getFromU->countluminairesBrand("products", $brandname);
                              ...
                              ?>
                                 <li>
                                    ...
                                    <a
                                       href="index.php?page=luminaire&brand_id=<?php echo $brand_id; ?>"
