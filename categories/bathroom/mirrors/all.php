                           ...
                           <div id="">
                              <div id="js-product-list-top" class="products-selection">
                                 <div class="col-md-6 hidden-md-down total-products">
                                    ...
                                    <?php 
                                      $get_prods = $getFromU->viewmirrorssBrand("products");
                                 ...
                                 <!---nav class="pagination row">
                                    ...
                                    <div class="col-md-8">
                                       <ul class="page-list clearfix text-xs-right">
                                          <?php
                                              //$total_pages = $getFromU->countmirrorsBrand("products", $per_page);
                                              //if ($total_pages >=2) {
                                            ?>
                                          <li  class="current <?php// if(isset($_GET['$page']) == 1) { echo 'active';}?>" >
                                             <a
                                                rel="nofollow"
                                                href="index.php?page=mirrors&$page=1"
                                          ...
                                          <li  class="current <?php// if(isset($_GET['$page']) == 1) { echo 'active';}?>" >
                                             <a
                                                rel="nofollow"
                                                href="index.php?page=mirrors&$page=<?php //echo $i; ?>"
                                          ...
                                          <li  class="current <?php //if(isset($_GET['$page']) == $total_pages) { echo 'active';}?>" >
                                             <a
                                                rel="nofollow"
                                                href="index.php?page=mirrors&$page=<?php //echo $total_pages; ?>"
