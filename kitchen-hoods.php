...
echo template_header('Kenadd kitchen hoods');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/kitchen/kitchen-hoods/sidebar.php' ?>
                  <?php include 'categories/kitchen/kitchen-hoods/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/kitchen/kitchen-hoods/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
