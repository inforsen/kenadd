...
echo template_header('Kenadd kitchen');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/storage-and-organizers/kitchen/sidebar.php' ?>
                  <?php include 'categories/storage-and-organizers/kitchen/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/storage-and-organizers/kitchen/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
