...
echo template_header('Kenadd Rugs');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/office-furniture/rugs/sidebar.php' ?>
                  <?php include 'categories/office-furniture/rugs/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/office-furniture/rugs/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
