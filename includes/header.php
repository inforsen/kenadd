...
<html lang="en">
   ...
   <body class="country-us currency-usd lang-en layout-full-width page-index tax-display-disabled"id="index">
      <main id="page">
      <header id="header">
            ...
            <div class="container">
               ...
               <div class="right-nav">
                  ...
                  <!--div class="user-info-side"id="verticalmenu_desktop_user_info">
                     ...
                     <a href="index.php?page=login"rel="nofollow"title="Log in to your customer account"><span>Sign in</span></a>
                                 ...
                                 <li class="category"id="cpcategory-9">
                                    ...
                                    <div class="collapse js-sub-menu popover sub-menu"id="top_sub_menu_28254">
                                       <ul class="top-menu"data-depth="1">
                                          ...
                                          <li class="category"id="cpcategory-35"><a class="dropdown-item dropdown-submenu"data-depth="1"href="index.php?page=pet-beds">Beds</a></li>
                                          ...
                                          <li class="category"id="cpcategory-37"><a class="dropdown-item dropdown-submenu"data-depth="1"href="index.php?page=pet-leashes">Leashes</a></li>
                                          ...
                                          <li class="category"id="cpcategory-37"><a class="dropdown-item dropdown-submenu"data-depth="1"href="index.php?page=pet-birds">Birds</a></li>
                              ...
                              <div class="block cart_block exclusive">
                                 ...
                                 <div class="card cart-summary">
                                    <div class="card-block">
                                       <div class="cart-summary-line"id="cart-subtotal-products"><span class="label js-subtotal">Items:<?php echo $getFromU->count_product_by_ip($ip_add); ?></span><span class="value">Kes<?php echo number_format((float)$totals,2); ?></span></div>
                                    ...
                                    <div class="card-block">
                                       <div class="cart-summary-line"><span class="label">Total (tax excl.)</span> <span class="value">Kes<?php echo number_format((float)(($totals+$shipping)-($totals*16)/100),2); ?></span></div>
                                       <div class="cart-summary-line cart-total"><span class="label">Total (tax incl.)</span> <span class="value">Kes<?php echo number_format((float)($totals+$shipping),2); ?></span></div>
                                       <div class="cart-summary-line"><span class="label sub">Taxes:</span> <span class="value sub">Kes<?php echo number_format((float)($tax=($totals*16)/100),2); ?></span></div>
                                    </div>
                                 </div>
                        ...
                        <li class="category"id="cpcategory-6">
                           ...
                           <div class="collapse js-sub-menu popover sub-menu"id="top_sub_menu_22032">
                              <ul class="top-menu cp_sf-menu"data-depth="1">
                                 ...
                                 <li class="category"id="cpcategory-8"><a class="dropdown-item dropdown-submenu"data-depth="1"href="index.php?page=pet-beds">Beds</a></li>
                                 ...
                                 <li class="category"id="cpcategory-32"><a class="dropdown-item dropdown-submenu"data-depth="1"href="index.php?page=pet-leashes">Leashes</a></li>
                                 <li class="category"id="cpcategory-33"><a class="dropdown-item dropdown-submenu"data-depth="1"href="index.php?page=pet-birds">Birds</a></li>
