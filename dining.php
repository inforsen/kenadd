...
echo template_header('Kenadd Dining');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/dining/sidebar.php' ?>
                  <?php include 'categories/furniture/dining/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/dining/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
