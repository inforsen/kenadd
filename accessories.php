...
echo template_header('Kenadd accessories');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/kitchen/accessories/sidebar.php' ?>
                  <?php include 'categories/kitchen/accessories/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/kitchen/accessories/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
