...
echo template_header('Kenadd Acrylic Fiber');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/textiles-and-rags/acrylic-fiber/sidebar.php' ?>
                  <?php include 'categories/textiles-and-rags/acrylic-fiber/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/textiles-and-rags/acrylic-fiber/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
