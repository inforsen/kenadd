...
echo template_header('Kenadd rob hooks');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/bathroom/rob-hooks/sidebar.php' ?>
                  <?php include 'categories/bathroom/rob-hooks/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/bathroom/rob-hooks/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
