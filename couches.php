...
echo template_header('Kenadd Couches');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/couches/sidebar.php' ?>
                  <?php include 'categories/furniture/couches/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/couches/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
