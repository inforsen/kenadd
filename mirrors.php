...
echo template_header('Kenadd mirrors');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/bathroom/mirrors/sidebar.php' ?>
                  <?php include 'categories/bathroom/mirrors/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/bathroom/mirrors/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
