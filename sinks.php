...
echo template_header('Kenadd sinks');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/kitchen/sinks/sidebar.php' ?>
                  <?php include 'categories/kitchen/sinks/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/kitchen/sinks/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
