...
<nav class="breadcrumb ">
  ...
  <section id="checkout-personal-information-step" class="checkout-step -reachable -complete -clickable -current js-current-step">
  ...
  <section id="checkout-addresses-step" class="checkout-step -reachable -clickable -unreachable">
    <h1 class="step-title js-step-title h3 not-allowed">
      <i class="material-icons rtl-no-flip done"></i>
