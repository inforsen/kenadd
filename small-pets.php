...
echo template_header('Kenadd small pets');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/pet-supplies/small-pets/sidebar.php' ?>
                  <?php include 'categories/pet-supplies/small-pets/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/pet-supplies/small-pets/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
