...
echo template_header('Kenadd Screen Prints');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/arts-and-prints/screen-prints/sidebar.php' ?>
                  <?php include 'categories/arts-and-prints/screen-prints/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/arts-and-prints/screen-prints/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
