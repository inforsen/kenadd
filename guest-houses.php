...
echo template_header('Kenadd guest houses');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/accommodation/guest-houses/sidebar.php' ?>
                  <?php include 'categories/accommodation/guest-houses/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/accommodation/guest-houses/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
