...
echo template_header('Kenadd motels');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/accommodation/motels/sidebar.php' ?>
                  <?php include 'categories/accommodation/motels/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/accommodation/motels/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
