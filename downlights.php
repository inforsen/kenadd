...
echo template_header('Kenadd Downlights');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/downlights/sidebar.php' ?>
                  <?php include 'categories/lighting/downlights/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/downlights/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
