...
echo template_header('Kenadd Stools');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/stools/sidebar.php' ?>
                  <?php include 'categories/furniture/stools/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/stools/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
