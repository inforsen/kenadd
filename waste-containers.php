...
echo template_header('Kenadd waste containers');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/kitchen/waste-containers/sidebar.php' ?>
                  <?php include 'categories/kitchen/waste-containers/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/kitchen/waste-containers/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
