...
echo template_header('Kenadd toilets');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/toilet/toilets/sidebar.php' ?>
                  <?php include 'categories/toilet/toilets/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/toilet/toilets/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
