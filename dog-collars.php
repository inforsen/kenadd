...
echo template_header('Kenadd pet birds');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/pet-supplies/dog-collars/sidebar.php' ?>
                  <?php include 'categories/pet-supplies/dog-collars/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/pet-supplies/dog-collars/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
