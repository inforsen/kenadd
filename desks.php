...
echo template_header('Kenadd Desks');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/furniture/desks/sidebar.php' ?>
                  <?php include 'categories/furniture/desks/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/furniture/desks/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
