...
echo template_header('Kenadd gadget organizers');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/storage-and-organizers/gadget-organizers/sidebar.php' ?>
                  <?php include 'categories/storage-and-organizers/gadget-organizers/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/storage-and-organizers/gadget-organizers/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
