...
echo template_header('Kenadd Recessed Lights');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/lighting/recessed-lights/sidebar.php' ?>
                  <?php include 'categories/lighting/recessed-lights/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/lighting/recessed-lights/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
