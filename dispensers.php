...
echo template_header('Kenadd dispensers');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/bathroom/dispensers/sidebar.php' ?>
                  <?php include 'categories/bathroom/dispensers/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/bathroom/dispensers/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
