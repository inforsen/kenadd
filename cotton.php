...
echo template_header('Kenadd Cotton');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/textiles-and-rags/cotton/sidebar.php' ?>
                  <?php include 'categories/textiles-and-rags/cotton/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/textiles-and-rags/cotton/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
