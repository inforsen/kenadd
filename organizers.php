...
echo template_header('Kenadd organizers');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/office-furniture/organizers/sidebar.php' ?>
                  <?php include 'categories/office-furniture/organizers/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/office-furniture/organizers/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
