...
echo template_header('Kenadd nylon');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/textiles-and-rags/nylon/sidebar.php' ?>
                  <?php include 'categories/textiles-and-rags/nylon/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/textiles-and-rags/nylon/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
