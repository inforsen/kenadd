...
echo template_header('Kenadd cabinet storages');?>
         ...
         <section id="wrapper">
            <div class="columns container">
               ...
               <div id="columns_inner">
                  ...
                  <?php include 'categories/storage-and-organizers/cabinet-storages/sidebar.php' ?>
                  <?php include 'categories/storage-and-organizers/cabinet-storages/all.php' ?>
...
/* NO BORDER SPINNER */
      ...
      $(document).ready(function(){
          ...
          function filter_data()
          {
              ...
              $.ajax({
                  url:"categories/storage-and-organizers/cabinet-storages/fetch_data.php",
                  method:"POST",
                  data:{
                     action:action, 
                     brand:brand, 
